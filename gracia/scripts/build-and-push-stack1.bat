@echo off
echo ========================================
echo BUILD Y PUSH - STACK 1
echo Imagen: 60071325/ht-232-03-gracia-garcia
echo ========================================
echo.
...
docker build -t 60071325/ht-232-03-gracia-garcia:latest -f Dockerfile .
...
docker images 60071325/ht-232-03-gracia-garcia:latest
...
docker push 60071325/ht-232-03-gracia-garcia:latest
...
echo https://hub.docker.com/r/60071325/ht-232-03-gracia-garcia
echo.
pause
